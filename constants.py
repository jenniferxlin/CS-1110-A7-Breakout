...
PADDLE_OFFSET = 30
#: the distance paddle moves after each key press
PADDLE_MOVE = 5
...
#: the offset of the first left brick from the left side
BRICK_X_OFFSET = (GAME_WIDTH-(BRICKS_IN_ROW * BRICK_WIDTH)+(BRICKS_IN_ROW-1)*
                  (BRICK_SEP_H))/2
...
######### BRICK COLOR CONSTANTS #########

# red brick
RED = colormodel.RED
# orange brick
ORANGE = colormodel.ORANGE
# yellow brick
YELLOW = colormodel.YELLOW
# green brick
GREEN = colormodel.GREEN
# cyan brick
CYAN = colormodel.CYAN
